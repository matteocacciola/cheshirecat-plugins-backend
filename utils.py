...
def is_cache_valid(cache_duration: int, cache_timestamp: Dict[str, datetime]) -> bool:
    """
    ...
    return datetime.now(timezone.utc) < cache_time + timedelta(minutes=cache_duration)


async def fetch_plugin_json(url) -> Dict:
